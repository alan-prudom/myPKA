...
| WS-005 | [[WS-005-daily-task-digest]] | Mack (scheduling, connection) + Larry (orchestrator, rendering) | Walks tasks and project files to compile a daily status digest of open, in-progress, blocked, and stale items, written to `Deliverables/`. References [[SOP-list-open-tasks]], [[GL-001-file-naming-conventions]]. |
