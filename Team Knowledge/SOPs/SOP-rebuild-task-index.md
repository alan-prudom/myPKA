...
`INDEX.md` is the resumption-summary view of the task folder. It exists so an agent or Alan can read one file at session boot and know what's open, in-progress, blocked, and recently closed without walking the tree.
