...
2. Filter mentally to "Open priority 1" and "In-progress with assignee likely active" — surface those to Alan first.
...
The output Alan sees at boot is a one-paragraph summary:
...
That's the resumption surface. Alan knows where to start without re-reading anything else.
